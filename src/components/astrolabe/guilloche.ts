...
export function updateGuilloche(
	...
	// Lines don't pop in/out at the twilight edge — they fade across a band
	// centred on the exclusion edge, so a line dims out as the zone sweeps over
	// it. Returns 0 (fully under the zone, skip), 1 (clear), or a ramp between.
