	...
	return buildSvg(
		...
		defs(
			...
			linearGradient(
				...
				stop({ offset: "0%", "stop-color": "#7C642E" }),
				stop({ offset: "16%", "stop-color": "#E7D7A2" }),
				stop({ offset: "38%", "stop-color": "#BC9C56" }),
				stop({ offset: "62%", "stop-color": "#F1E8C4" }),
				stop({ offset: "84%", "stop-color": "#A6873F" }),
				stop({ offset: "100%", "stop-color": "#5E4A23" }),
			),
		),
